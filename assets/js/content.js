window.SEKISEN_CONTENT = {
  ...
  home: {
    ...
    product: {
      ...
      title: "違いは、三つで足りる。",
      lead:
        "皮際の甘さ、青臭さの少なさ、贈ったときの整い方。石戦の価値は、多くを語らなくてもこの三つで伝わります。",
      visuals: [
        {
          image: "./assets/images/product-cutaway.svg",
          alt: "石戦トマトの断面と果肉の密度が伝わるビジュアル",
          caption: "皮際まで味が痩せない、断面の密度。"
        },
        {
          image: "./assets/images/product-surface.svg",
          alt: "石戦トマトの張りとみずみずしさが伝わる近接ビジュアル",
          caption: "みずみずしさが、青さより先に立つ。"
        },
        {
          image: "./assets/images/product-box.svg",
          alt: "石戦トマトの箱と贈答としての整い方が伝わるビジュアル",
          caption: "箱を開ける前から、贈答として整っている。"
        }
      ],
      highlights: [
        {
          ...
          title: "皮の近くまで甘い。",
          text:
            "中心だけが甘いのではなく、外側まで味が痩せにくい。ひと口目で、密度の違いが分かります。"
        },
        {
          label: "Clean Finish",
          title: "青臭さが、後に残りにくい。",
          text:
            "みずみずしいのに、青い雑味が立ちにくい。あと味が澄むから、食後の印象まできれいです。"
        },
        {
          label: "Gift Value",
          title: "一箱で、贈り物になる。",
          text:
            "味だけでなく、並び方と見え方まで整える。届いた瞬間に『きちんとしている』と伝わります。"
        }
      ],
      summary:
        "味覚だけでなく、印象まで整っている。それが石戦の価値です。",
      ctas: [
        {
          label: "商品を見る",
          href: "./lineup.html",
